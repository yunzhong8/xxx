function terrplotobs(qmethod,sol,eldata,evt,xy,x,y,figno,axis_value)
%TERRPLOTOBS   plots solution and error estimate on obstacle domain
...
subplot(212),contour(X,Y,xysol,200),axis('equal')
title('estimated error')
%subplot(212),mesh(X,Y,xysol),
%axis(axis_value,'equal')
%view(330,30)
subplot(111)
fprintf('done\n')
return