function terrplotl(qmethod,sol,eldata,evt,xy,x,y,figno,axis_value)
%TERRPLOTL   plots solution and error estimate on L-shaped domain
%terrplotl(qmethod,sol,eldata,evt,xy,x,y,figno)
%   input
...
%    TIFISS function: QL; 3 March 2011. 
