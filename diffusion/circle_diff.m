...
y=[yymin:yyd:yymax];
tsolplot(qmethod,x_gal,evt(:,1:3),xy,x,y,12,[xxmin,xxmax,yymin,yymax]);
drawnow
%
%
...
if qmethod==1
   ...
   terrplot(qmethod,x_gal,elerror_p,evt,xy,x,y,101);
...
elseif qmethod==2
   ...
   terrplot(qmethod,x_gal,elerr_p_p4,evt,xy,x,y,102,[xxmin,xxmax,yymin,yymax]);
end
