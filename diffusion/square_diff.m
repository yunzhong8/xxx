...
if sn==1, square_domain(1,1)
   elseif sn==2, square_domain(1,0)
   elseif sn==9, square_domain(2,1)
   else, square_domain(1,0) 
end 
load square_grid
...
x=xmin:1/300:xmax;
y=ymin:1/300:ymax;
tsolplot(qmethod,x_gal,evt(:,1:3),xy,x,y,12,[xmin,xmax,ymin,ymax]);
drawnow
...
if qmethod==1
   ...
   terrplot(qmethod,x_gal,elerror_p,evt,xy,x,y,101,[xmin,xmax,ymin,ymax]);
...
elseif qmethod==2
   ...
   terrplot(qmethod,x_gal,elerr_p_p4,evt,xy,x,y,102,[xmin,xmax,ymin,ymax]);
end
