function [eex,tve,els] = tedgegen_old(xy,evt)
%TEDGEGEN_OLD legacy code
%
%   [eex,tve,els] = tedgegen_old(xy,evt)
%
%   input:
...
%
%   TIFISS function: LR; 28 August 2017.
% Copyright (c) 2017 A. Bespalov, L. Rocchi

  fprintf('   computing edge connections and edge lengths...');
...
% It means that the neighbours of element i-th are elements p,q,r and 
...
% It means that the neighbours of element j-th are elements p,q,r and
...
% Ex 1:   row i-th    ->    1    3    2
% It means that element i-th lies respectively on the 1st, 3rd, and 2nd 
% edge of its corresponding neighbours, which are stored in eex(i,:)
% Ex 2:   row i-th    ->    0    2    1
% It means that element i-th is a boundary element (in particular, its 
